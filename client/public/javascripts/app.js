...
module.exports = ScheduleItemsCollection = (function(_super) {
  ...
  function ScheduleItemsCollection() {
    this.getFCEventSource = __bind(this.getFCEventSource, this);    _ref = ScheduleItemsCollection.__super__.constructor.apply(this, arguments);
    return _ref;
  }
...
module.exports = Router = (function(_super) {
  ...
  function Router() {
    ...
    this.backToCalendar = __bind(this.backToCalendar, this);    _ref = Router.__super__.constructor.apply(this, arguments);
    return _ref;
  }
...
module.exports = EventModal = (function(_super) {
  ...
  function EventModal() {
    ...
    this.hideOnEscape = __bind(this.hideOnEscape, this);    _ref = EventModal.__super__.constructor.apply(this, arguments);
    return _ref;
  }
...
with (locals || {}) {
var interp;
buf.push('<div class="helptext"><h2>Synchronization</h2></div><div class="helptext"><h3>Mobile sync (Caldav)</h3>To synchronize your calendar with your devices, you must follow two\nsteps:<ol><li>Install the webdav module from the Cozy App Store</li><li>Connect to it and follow the instructions related to CalDAV.</li></ol></div><div class="helptext"><h3>ICalendar Export</h3>To download a copy of your calendar on your computer as an ICal file, click\non this button : &nbsp;<a href="export/calendar.ics" class="btn">Export your calendar</a></div><div class="helptext"><h3>');
