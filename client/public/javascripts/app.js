...
module.exports = PopOver = (function(_super) {
  ...
  function PopOver() {
    ...
    this.onRemoveClicked = __bind(this.onRemoveClicked, this);    _ref = PopOver.__super__.constructor.apply(this, arguments);
    return _ref;
  }
...
var Alarm, AlarmPopOver, PopOver, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = AlarmPopOver = (function(_super) {
  ...
  function AlarmPopOver() {
    _ref = AlarmPopOver.__super__.constructor.apply(this, arguments);
    return _ref;
  }

  AlarmPopOver.prototype.type = 'alarm';

  AlarmPopOver.prototype.initialize = function() {
    AlarmPopOver.__super__.initialize.apply(this, arguments);
    return this.date = this.model.getDateObject();
  };

  AlarmPopOver.prototype.validForm = function() {
  ...
  AlarmPopOver.prototype.getRenderData = function() {
    return _.extend(this.model.attributes, {
      ...
      time: this.model.getDateObject().format('{HH}:{mm}')
    });
  };
...
module.exports = EventPopOver = (function(_super) {
  ...
  EventPopOver.prototype.type = 'event';

  EventPopOver.prototype.initialize = function() {
    EventPopOver.__super__.initialize.apply(this, arguments);
    return this.date = this.model.getStartDateObject();
  };

  EventPopOver.prototype.validForm = function() {
...
var Alarm, AlarmPopOver, BaseView, CalendarView, Event, EventPopOver, app, helpers, timezones, _ref,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = CalendarView = (function(_super) {
  ...
  CalendarView.prototype.showPopover = function(options) {
    ...
    klass = options.model instanceof Event ? EventPopOver : AlarmPopOver;
...
buf.push(escape(null == __val__ ? "" : __val__));
buf.push('</div><div class="modal-body"><form id="basic" class="form-inline"><div class="row-fluid"><div class="control-group span12"><label for="basic-summary" class="control-label">');
...
buf.push(escape(null == __val__ ? "" : __val__));
buf.push('</a></p><p id="rrule-short"><span id="rrule-help"></span><a class="rrule-show">');
var __val__ = t('change')
buf.push(escape(null == __val__ ? "" : __val__));
buf.push('</a></p><form id="rrule" class="form-inline"><div class="control-group"><label for="rrule-interval" class="control-label">');
var __val__ = t('repeat every')
buf.push(escape(null == __val__ ? "" : __val__));
buf.push('</label><div class="controls"><input');
buf.push(attrs({ 'type':("number"), 'value':(rrule.interval), 'id':('rrule-interval'), "class": ('input-mini') }, {"type":true,"value":true}));
...
var __val__ = units[7]
buf.push(escape(null == __val__ ? "" : __val__));
buf.push('</option></select></div></div><div id="rrule-weekdays" class="control-group"><label class="control-label">');
var __val__ = t('repeat on')
buf.push(escape(null == __val__ ? "" : __val__));
buf.push('</label><div class="controls"><label class="checkbox inline">');
...
buf.push('/></label></div></div><div id="rrule-monthdays" class="control-group"><label>');
var __val__ = t('repeat on')
buf.push(escape(null == __val__ ? "" : __val__));
...
{
buf.push('<a');
buf.push(attrs({ 'href':("#events/" + (id) + "") }, {"href":true}));
buf.push('>advanced</a>');
}
buf.push('</div>');
}
