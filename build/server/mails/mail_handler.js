...
module.exports.sendInvitations = function(event, dateChanged, callback) {
  ...
  return async.parallel([
    ...
    return async.forEach(guests, function(guest, done) {
      var calendar, calendarOptions, date, dateFormat, dateFormatKey, description, htmlTemplate, icsPath, mailOptions, place, ref, shouldSend, subject, subjectKey, templateKey, templateOptions, url;
