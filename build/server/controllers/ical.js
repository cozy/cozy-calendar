...
var Event, Tag, User, archiver, async, createCalendar, fs, ical, localization, log, moment, multiparty;
    ...
    return parser.parseFile(file.path, options, function(err, result) {
      if (err) {
        ...
        return Event.tags(function(err, tags) {
          var calendarName, calendars, defaultCalendar, e, error, events, key, ref1;
