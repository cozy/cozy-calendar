...
var Contact, Event, Sharing, Tag, User, WebDavAccount, async, cozydb, log, moment;
...
module.exports.index = function(req, res, next) {
  return async.parallel([
    ...
    var calendars, contacts, events, instance, locale, pendingEventSharings, sanitize, tags, timezone, webDavAccount;
    if (err) {
      return next(err);
    }
    contacts = results[0], tags = results[1], calendars = results[2], events = results[3], pendingEventSharings = results[4], instance = results[5], webDavAccount = results[6], timezone = results[7];
