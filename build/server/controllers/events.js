...
var Event, MailHandler, ShareHandler, User, VCalendar, async, localization, moment;
...
module.exports.createBulk = function(req, res, next) {
...
module.exports["public"] = function(req, res, next) {
  ...
  key = req.query.key;
  return Event.find(id, function(err, event) {
    var date, dateFormat, dateFormatKey, day, desc, locale, ref, ref1, ref2, specialCharacters, visitor;
    if (err || !event || !(visitor = event.getGuest(key))) {
      locale = (ref = localization.polyglot) != null ? ref.locale() : void 0;
      if (locale !== 'fr') {
        locale = 'en';
      }
      res.status(404);
      return res.render("404_" + locale);
    } else if ((ref1 = req.query.status) === 'ACCEPTED' || ref1 === 'DECLINED') {
      ...
      locale = ((ref2 = localization.polyglot) != null ? ref2.locale() : void 0) || 'en';
      ...
      return res.render("event_public_" + locale, {
        event: event,
        file: day + "-" + desc,
        date: date,
        key: key,
